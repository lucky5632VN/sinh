  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#020617', color: '#f1f5f9', fontFamily: 'sans-serif', overflow: 'hidden' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ lineHeight: 1.2 }}>
              ...
              <p style={{ fontSize: '10px', color: '#ec4899', fontWeight: 600, margin: 0 }}>Hệ sinh sản nữ (Female Reproductive System)</p>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flex: 1, justifyContent: 'flex-end' }}>
          ...
          <button
            ...
            style={{
              display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px',
              backgroundColor: '#ec4899', border: 'none', borderRadius: '10px',
              color: 'white', fontSize: '12px', fontWeight: 600, cursor: 'pointer',
              boxShadow: '0 4px 15px rgba(236, 72, 153, 0.3)', transition: 'all 0.2s'
            }}
      ...
      <main style={{ flex: 1, backgroundColor: '#020617', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px' }}>
        {isLoading && (
          <div style={{
            ...
            <div style={{ width: '40px', height: '40px', border: '3px solid rgba(236, 72, 153, 0.2)', borderTopColor: '#ec4899', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
        ...
        <div style={{ width: '100%', height: '100%', maxWidth: '1200px', maxHeight: '800px', position: 'relative', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)' }}>
          <iframe
            ref={iframeRef}
            src="/external/native/female-reproductive-system/index.html"
            onLoad={handleIframeLoad}
            style={{ width: '100%', height: '100%', border: 'none' }}
            title="Female Reproductive System Simulation"
          />
        </div>
      </main>
      ...
      <div style={{
        ...
        <div style={{ width: '6px', height: '6px', borderRadius: '50%', backgroundColor: '#ec4899', boxShadow: '0 0 10px #ec4899', animation: 'pulse 2s infinite' }} />
...
export default FemaleReproductiveLab;
