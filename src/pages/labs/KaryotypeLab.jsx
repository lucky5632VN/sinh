...
const KaryotypeLab = () => {
  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#020617', color: '#f1f5f9', fontFamily: 'sans-serif', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ lineHeight: 1.2 }}>
              ...
              <p style={{ fontSize: '10px', color: '#a855f7', fontWeight: 600, margin: 0 }}>Hoạt động bộ nhiễm sắc thể (Karyotype)</p>
            </div>
          </div>
        </div>
      ...
      {/* Main Content */}
      <main style={{ flex: 1, backgroundColor: '#000000', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0' }}>
        {isLoading && (
          <div style={{
        ...
        <div style={{ width: '100%', height: '100%', maxWidth: '100vw', maxHeight: '100vh', position: 'relative', borderRadius: '0', overflow: 'hidden', background: '#000' }}>
          <iframe
            ref={iframeRef}
            src="/external/native/karyotype-activities/index.html"
            onLoad={handleIframeLoad}
            style={{ width: '100%', height: '100%', border: 'none', backgroundColor: '#000' }}
            title="Karyotype Simulation"
          />
        </div>
      </main>
      ...
      <div style={{
        ...
        <div style={{ width: '6px', height: '6px', borderRadius: '50%', backgroundColor: '#a855f7', boxShadow: '0 0 10px #a855f7', animation: 'pulse 2s infinite' }} />
