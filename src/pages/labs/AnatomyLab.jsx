  ...
  return (
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#020617', color: '#f1f5f9', fontFamily: 'sans-serif', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ lineHeight: 1.2 }}>
              ...
              <p style={{ fontSize: '10px', color: '#fb7185', fontWeight: 500, margin: 0 }}>Giải Phẫu Cơ Thể Người</p>
            </div>
          </div>
        </div>
      ...
      <main style={{ flex: 1, backgroundColor: '#020617', position: 'relative', overflow: 'hidden' }}>
        <iframe 
          ref={iframeRef}
          src="/external/anatomy/index.html" 
          style={{ width: '100%', height: '100%', border: 'none' }}
          title="Human Anatomy Simulation"
        />
        
        {/* Subtle decorative border focus */}
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', borderTop: '1px solid rgba(244, 63, 94, 0.1)' }} />
      </main>
      ...
      <div style={{ 
        ...
        <div style={{ width: '4px', height: '4px', borderRadius: '50%', backgroundColor: '#f43f5e', boxShadow: '0 0 6px #f43f5e' }} />
